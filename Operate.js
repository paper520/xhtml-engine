...
exports.innerHTML = function () {
    ...
    // 如果是文本结点
    if (this[0].type == 'text') return this[0].content;
     ...
     * 
     */
    let needCalcs = [this.__DomTree__[this[0]]], index = 0, currentNode, attrsString, needReplace;
        ...
        if (currentNode.type == 'tag') {
            ...
            if (currentNode.__tagType__ == 'double') {
                ...
                for (let i = 0; i < currentNode.childNodes.length; i++) {
                    needReplace.push(this.__DomTree__[currentNode.childNodes[i]]);
                }
